...
#######################################################
# tools/make_describe.sh /usr/lib/llvm-17/lib/libclang.so
# tools/make_describe.sh /usr/lib/libclang.so ./model.hpp ./describe_all.gen.hpp
# (macOS Homebrew)
# tools/make_describe.sh /opt/homebrew/opt/llvm/lib/libclang.dylib
